      ...
      <div className="relative z-10">
        ...
        <section className="h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-full w-full mx-auto">
            <h1 className="text-6xl font-light text-white mb-4">Development Overview</h1>
            ...
            <div className="mt-16 max-w-4xl mx-auto">
              ...
              <p className="text-white/90 leading-relaxed font-light">
                ...
                <span className="font-medium">NeuroView's neural network was built entirely from scratch.</span>{' '}
        ...
        <section className="min-h-screen flex flex-col items-center justify-center py-20 px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <div className="max-w-2xl mx-auto space-y-16">
              ...
              <div>
                <img src="/dp.png" alt="Dataset & Preprocessing" className="w-auto mx-auto mb-4" />
                <h3 className="text-2xl font-light mb-4">Dataset & Preprocessing</h3>
              </div>

              {/* Model Architecture */}
              <div>
                <img src="/ma.png" alt="Model Architecture" className="w-auto mx-auto mb-4" />
                <h3 className="text-2xl font-light mb-4">Model Architecture</h3>
              </div>

              {/* Training & Optimization */}
              <div>
                <img src="/to.png" alt="Training & Optimization" className="w-auto mx-auto mb-4" />
                <h3 className="text-2xl font-light mb-4">Training & Optimization</h3>
              </div>

              {/* Evaluation Metrics */}
              <div>
                <img src="/em.png" alt="Evaluation Metrics" className="w-auto mx-auto mb-4" />
                <h3 className="text-2xl font-light mb-4">Evaluation Metrics</h3>
              </div>

              {/* Future Improvements */}
              <div>
                <img src="/fi.png" alt="Future Improvements" className="w-auto mx-auto mb-4" />
                <h3 className="text-2xl font-light mb-4">Future Improvements</h3>
              </div>
            </div>
          </div>
        </section>
