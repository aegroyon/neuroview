...
export default function ImageDetail({ id }) {
  ...
  const rawTumorType = image.information?.tumor_type || "Unknown";
  ...
  const tumorType = formatTumorType(rawTumorType);
      ...
      <div className="pr-5 pb-16">
        <div className="max-w-6xl w-full mx-auto space-y-16">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              <h2 className="text-lg uppercase tracking-wider mb-8">
                CONFIDENCE SCORES
              </h2>
              ...
              <div className="space-y-6">
                {Object.entries(probabilities).map(
                  ([className, probability]) => {
                    const displayName = formatTumorType(className);
            ...
            {tumorType && tumorType !== "Unknown" && (
              <div className="max-w-4xl mx-auto text-left bg-gray-900/50 rounded-2xl p-8 space-y-6">
                ...
                <div className="text-center border-b border-gray-700 pb-6">
                  <h3 className="text-2xl font-light mb-2 capitalize">
                    {tumorType}
                  </h3>
                  <p className="text-gray-400">
                    ...
                    {tumorType.toLowerCase() === "meningioma" &&
                      "Tumor arising from brain's protective layers"}
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    {tumorType.toLowerCase() === "glioma" && (
                      <>
                        Gliomas are tumors that arise from glial cells, which
                        are the supportive cells in the brain. They are the most
                        common type of primary brain tumor, accounting for about
                        80% of all malignant brain tumors. Gliomas can vary
                        greatly in their aggressiveness and treatment approach.
                        <br />
                        <br />
                        Gliomas are classified into different grades (I-IV)
                        based on how abnormal the cells look under a microscope
                        and how quickly they are likely to grow and spread.
                      </>
                    )}
                    {tumorType.toLowerCase() === "meningioma" && (
                      <>
                        ...
                        spinal cord. They are typically slow-growing and often
                        benign, though some can be atypical or malignant.
                        <br />
                        <br />
                        Meningiomas are more common in women than men and their
                        incidence increases with age. They account for about 30%
                        of all primary brain tumors.
                      </>
                    )}
                    {tumorType.toLowerCase() === "pituitary" && (
                      <>
                        Pituitary tumors develop in the pituitary gland, a small
                        pea-sized gland at the base of the brain that controls
                        several other hormone-producing glands. Most pituitary
                        tumors are benign (non-cancerous) adenomas.
                        <br />
                        <br />
                        These tumors can be functional (producing excess
                        hormones) or non-functional (not producing hormones).
                        The symptoms depend on whether the tumor produces
                        hormones and which hormones are affected.
                      </>
                    )}
                    {(tumorType.toLowerCase() === "notumor" ||
                      tumorType.toLowerCase() === "no tumor") && (
                      <>
                        The brain scan shows no signs of tumor or abnormal
                        growth. This indicates healthy brain tissue with normal
                        cellular structure and function. The neural pathways,
                        blood vessels, and brain tissues appear to be
                        functioning within normal parameters.
                        <br />
                        <br />A healthy brain efficiently processes information,
                        maintains proper blood flow, and coordinates essential
                        functions including movement, cognition, memory, and
                        sensory processing. Regular monitoring and maintaining a
                        healthy lifestyle continue to support optimal brain
                        health.
                      </>
                    )}
                  </p>
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    {(tumorType.toLowerCase() === "notumor" ||
                      tumorType.toLowerCase() === "no tumor") &&
                      "No treatment is required as no abnormal growths were detected. To maintain optimal brain " +
                        "health, continue with regular exercise, a balanced diet rich in omega-3 fatty acids, " +
                        "adequate sleep, stress management, and mental stimulation. Regular health check-ups and " +
                        "following up with healthcare providers as recommended will help ensure continued brain wellness."}
                  </p>
                </div>
                ...
                >
                  ...
                  >
                    ...
                    qualified healthcare professionals for accurate diagnosis
                    and
                    {tumorType.toLowerCase() === "notumor" ||
                    tumorType.toLowerCase() === "no tumor"
